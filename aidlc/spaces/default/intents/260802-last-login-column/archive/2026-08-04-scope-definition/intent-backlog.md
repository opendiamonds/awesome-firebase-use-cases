...
<!-- Text fallback: PU-1 至 PU-3 為線性依賴鏈；PU-3 另需 N 值於 requirements-analysis 定案；PU-4 與鏈無技術依賴、平行進行但排序殿後。 -->

四項全為 Must、一起上線才算完成 [Q1]；不設 Should／Could 層。細部 Unit 切分與 Bolt 經濟排序交由 inception 的 units-generation 與 delivery-planning。

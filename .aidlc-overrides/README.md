...
| `continuous-delivery.md` | Replace the "Construction → Operations linear handoff" with a continuous DevOps loop | Overrides upstream's linear three-phase assumption (see ADR-0008) |
